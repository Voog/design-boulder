:root {
  /* VoogStyle
    ...
    "featured": true
  */
  --blog-list-label-font-size: 20px;
  /* VoogStyle
     "pathI18n": ["blog", "label"],
     ...
     "scope": "global"
  */
  --blog-list-label-line-height: 1.7;
  /* VoogStyle
    "pathI18n": ["blog", "label"],
    ...
    "scope": "global"
  */
  --blog-list-label-font-weight: 400;
  /* VoogStyle
    "pathI18n": ["blog", "label"],
    ...
    "scope": "global"
  */
  --blog-list-label-font-style: italic;
  /* VoogStyle
    "pathI18n": ["blog", "label"],
    ...
    "scope": "global"
  */
  --blog-list-label-text-decoration: none;
  /* VoogStyle
    "pathI18n": ["blog", "label"],
    ...
    "scope": "global"
  */
  --blog-list-label-text-transform: none;
  /* VoogStyle
    "pathI18n": ["blog", "title"],
    "titleI18n": "size",
    "editor": "rangePicker",
